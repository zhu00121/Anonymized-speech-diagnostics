...
if __name__ == '__main__':
    ...
    # CSS_kwargs = {'label_train_path':'/mnt/d/projects/COVID-datasets/CSS/label/train.csv',\
    #             'label_valid_path':'/mnt/d/projects/COVID-datasets/CSS/label/dev.csv',\
    #             'label_test_path':'/mnt/d/projects/COVID-datasets/CSS/label/test.csv',\
    #             'ad_folder':'/mnt/d/projects/COVID-datasets/CSS/audio'}
    # clean_CSS(**CSS_kwargs)


    # DiCOVA2_kwargs = {'label_path':'/mnt/d/projects/COVID-datasets/DiCOVA2/label/metadata.csv',\
    #                 'ad_folder':'/mnt/d/projects/COVID-datasets/DiCOVA2/audio/speech', \
    #                 'pd_train':'/mnt/d/projects/COVID-datasets/DiCOVA2/lists/train_2.csv', \
    #                 'pd_test':'/mnt/d/projects/COVID-datasets/DiCOVA2/lists/val_2.csv'}
    # clean_DiCOVA2(**DiCOVA2_kwargs)


    # Cambridge_kwargs = {
    #     'label_path':'/mnt/d/projects/COVID-datasets/Cambridge_Task2/label/metadata.csv',\
    #     'ad_folder':'/mnt/d/projects/COVID-datasets/Cambridge_Task2/audio'
    # }
    # clean_Cambridge(**Cambridge_kwargs)